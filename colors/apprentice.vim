...
" ========================================================================
" almost black    #071933    rgb(28, 28, 28)       234    0
" darker grey     #091f3f    rgb(38, 38, 38)       235    background color
...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal           ctermbg=235  ctermfg=250  guibg=#091f3f guifg=#bcbcbc cterm=NONE           gui=NONE
  hi LineNr           ctermbg=234  ctermfg=242  guibg=#071933 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi FoldColumn       ctermbg=234  ctermfg=242  guibg=#071933 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi Folded           ctermbg=234  ctermfg=242  guibg=#071933 guifg=#6c6c6c cterm=NONE           gui=NONE
  hi MatchParen       ctermbg=234  ctermfg=229  guibg=#071933 guifg=#ffffaf cterm=NONE           gui=NONE
  hi signColumn       ctermbg=234  ctermfg=242  guibg=#071933 guifg=#6c6c6c cterm=NONE           gui=NONE
  ...
  hi PmenuSel         ctermbg=66   ctermfg=235  guibg=#5f8787 guifg=#091f3f cterm=NONE           gui=NONE
  hi PmenuThumb       ctermbg=66   ctermfg=66   guibg=#5f8787 guifg=#5f8787 cterm=NONE           gui=NONE

  hi ErrorMsg         ctermbg=131  ctermfg=235  guibg=#af5f5f guifg=#091f3f cterm=NONE           gui=NONE
  hi ModeMsg          ctermbg=108  ctermfg=235  guibg=#87af87 guifg=#091f3f cterm=NONE           gui=NONE
  ...
  hi TabLineSel       ctermbg=101  ctermfg=235  guibg=#87875f guifg=#091f3f cterm=NONE           gui=NONE
  ...
  hi StatusLine       ctermbg=101  ctermfg=235  guibg=#87875f guifg=#091f3f cterm=NONE           gui=NONE
  hi StatusLineNC     ctermbg=238  ctermfg=101  guibg=#444444 guifg=#87875f cterm=NONE           gui=NONE

  hi StatusLineTerm   ctermbg=101  ctermfg=235  guibg=#87875f guifg=#091f3f cterm=NONE           gui=NONE
  hi StatusLineTermNC ctermbg=238  ctermfg=101  guibg=#444444 guifg=#87875f cterm=NONE           gui=NONE

  hi Visual           ctermbg=235  ctermfg=110  guibg=#091f3f guifg=#8fafd7 cterm=reverse        gui=reverse
  ...
  hi WildMenu         ctermbg=110  ctermfg=235  guibg=#8fafd7 guifg=#091f3f cterm=NONE           gui=NONE
  ...
  hi DiffAdd          ctermbg=235  ctermfg=108  guibg=#091f3f guifg=#87af87 cterm=reverse        gui=reverse
  hi DiffChange       ctermbg=235  ctermfg=103  guibg=#091f3f guifg=#8787af cterm=reverse        gui=reverse
  hi DiffDelete       ctermbg=235  ctermfg=131  guibg=#091f3f guifg=#af5f5f cterm=reverse        gui=reverse
  hi DiffText         ctermbg=235  ctermfg=208  guibg=#091f3f guifg=#ff8700 cterm=reverse        gui=reverse

  hi IncSearch        ctermbg=131  ctermfg=235  guibg=#af5f5f guifg=#091f3f cterm=NONE           gui=NONE
  hi Search           ctermbg=229  ctermfg=235  guibg=#ffffaf guifg=#091f3f cterm=NONE           gui=NONE
  ...
  hi ColorColumn      ctermbg=234  ctermfg=NONE guibg=#071933 guifg=NONE    cterm=NONE           gui=NONE
